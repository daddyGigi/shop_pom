    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')">
                    <IMG height="350" src="http://192.168.191.191:8080/${images[0]}" jqimg="images/img04.jpg" width="350">
                </div>
                <div id="spec-n5">
                    <div class=control id="spec-left">
                        <img src="http://192.168.191.191:8080/${images[0]}" />
                    </div>
                    <div id="spec-list">
                        <ul class="list-h">
                            <#list images as image>
                            <li><img src="http://192.168.191.191:8080/${image}"> </li>
                            </#list>
                        </ul>
                    </div>
        ...
        <div class="shop_goods_show_right">
            <ul>
                ...
                <li class="goods_num">
                    <label>购买数量：</label>
                    <span><a class="good_num_jian" id="good_num_jian" href="javascript:void(0);">

                        </a><input type="text" value="1" id="good_nums" class="good_nums" />
